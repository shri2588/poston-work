...
@section('content')
    <div class="container-fluid px-lg-5 py-4">
      <div class="d-flex align-items-center">
        <h4 class="text-secondary">woocommerce settings</h4>
        ...
        <span><i class="ri-arrow-right-s-line text-secondary"></i></span>
        <p class="text-primary m-0 p-0 ms-2">woocommerce settings</p>
      </div>

      <button class="mt-4">
        <i class="ri-add-circle-line"></i> woocommerce
      </button>
          ...
          <div class="col">
            <table class="table border">
              <thead>
                <tr>
                  <th scope="col">#</th>
                  <th scope="col">woocommerce Name</th>
                  <th scope="col">woocommerce ID</th>
                  <th scope="col">woocommerce SECRET</th>
