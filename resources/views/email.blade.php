...
@section('content')
    <div class="container-fluid px-lg-5 py-4">
      <div class="d-flex align-items-center">
        <h4 class="text-secondary">Email settings</h4>
        ...
        <span><i class="ri-arrow-right-s-line text-secondary"></i></span>
        <p class="text-primary m-0 p-0 ms-2">Email settings</p>
      </div>

      <button class="mt-4">
        <i class="ri-add-circle-line"></i> Create an email
      </button>
